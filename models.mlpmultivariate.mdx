...
# <kbd>module</kbd> `neuralforecast.models.mlpmultivariate`
...
**Args:**
 ...
 - <b>`num_layers`</b> (int):  number of layers for the MLP. 
 - <b>`hidden_size`</b> (int):  number of units for each layer of the MLP. 
