...
Architecture.](/neuralforecast/imgs_models/informer_architecture.png)
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/informer.py#L64"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/informer.py#L50"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/informer.py#L168"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
throughout Informer architecture.<br/> `factor`: int=3, Probsparse
