...
`futr_cat_exog_list` | <code>list of str</code> | optional (default=None), categorical future exogenous columns; subset of `futr_exog_list`, fed through learned embeddings instead of being scaled. | <code>None</code>
`hist_cat_exog_list` | <code>list of str</code> | optional (default=None), categorical historic exogenous columns; subset of `hist_exog_list`, fed through learned embeddings instead of being scaled. | <code>None</code>
`categorical_cardinalities` | <code>[dict](#dict)</code> | optional (default=None), mapping from each categorical column to its number of distinct categories. | <code>None</code>
