...
`cat_exog_list` | <code>list of str</code> | optional (default=None), exogenous columns (from `hist_exog_list` / `futr_exog_list`) to embed instead of scale. | <code>None</code>
...
`optimizer_kwargs` | <code>[dict](#dict)</code> | optional (default=None), List of parameters used by the user specified `optimizer`. | <code>None</code>
