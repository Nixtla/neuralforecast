...
### Example: simplified MLP model {#example-simplified-mlp-model}
...
### b. `BaseWindows`’ hyperparameters {#b.-basewindows-hyperparameters}
...
### b. Tests and documentation {#b.-tests-and-documentation}
