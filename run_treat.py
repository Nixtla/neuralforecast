...
from neuralforecast.auto import AutoNHITS_TREAT, AutoTFT

from config import config_nhits_treat, config_tft_treat

MODEL_DICT = {'nhits': AutoNHITS_TREAT,
              'tft': AutoTFT}
CONFIG_DICT = {'nhits': config_nhits_treat,
               'tft': config_tft_treat}
...
def main(args):
    ...
    # Save forecasts
    forecasts_dir = f'./results_glucose/h_{args.horizon}/treat/'
