...
**Args:**
 ...
 - <b>`model`</b> (NeuralForecast model):  Instantiated model class from [architecture collection](https://nixtla.github.io/neuralforecast/models.pytorch.html). 
 - <b>`S`</b> (np.ndarray):  Dumming matrix of size (`base`, `bottom`) see HierarchicalForecast's [aggregate method](https://nixtla.github.io/hierarchicalforecast/utils.html#aggregate). 
...
**Args:**
 ...
 - <b>`dataset`</b> (TimeSeriesDataset):  NeuralForecast's `TimeSeriesDataset` see details [here](https://nixtlaverse.nixtla.io/neuralforecast/tsdataset) 
