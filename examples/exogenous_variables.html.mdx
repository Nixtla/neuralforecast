...
minimal example visit the [Getting Started](./getting_started.html)
guide.
...
![](/examples/Exogenous_Variables_files/figure-markdown_strict/cell-5-output-1.png)
...
Make sure `futr_df` has informations for the entire forecast horizon. In
this example, we are forecasting 24 hours ahead, so `futr_df` must have
24 rows for each time series.
...
![](/examples/Exogenous_Variables_files/figure-markdown_strict/cell-12-output-1.png)
