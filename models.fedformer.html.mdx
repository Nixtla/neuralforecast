...
`futr_cat_exog_list` | <code>[List](#List)\[[str](#str)\]</code> | categorical future exogenous columns; subset of `futr_exog_list`, fed through learned embeddings instead of being scaled. | <code>None</code>
`hist_cat_exog_list` | <code>[List](#List)\[[str](#str)\]</code> | categorical historic exogenous columns; subset of `hist_exog_list`, fed through learned embeddings instead of being scaled. | <code>None</code>
