...
**Args:**
 ...
 - <b>`explainer`</b> (str):  Name of the explainer to use. Options are 'IntegratedGradients', 'ShapleyValueSampling', 'InputXGradient'. Defaults to 'IntegratedGradients'. 
 ...
 - <b>`h`</b> (int):  The forecast horizon. Can be larger than the horizon set during training. 
 - <b>`verbose`</b> (bool):  Print processing steps. Defaults to False. 
