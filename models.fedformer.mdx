...
# <kbd>module</kbd> `neuralforecast.models.fedformer`
...
## <kbd>function</kbd> `get_frequency_modes`
...
## <kbd>class</kbd> `FourierCrossAttention`
...
**Args:**
 ...
 - <b>`stat_exog_list`</b> (List[str]):  static exogenous columns. 
 - <b>`hist_exog_list`</b> (List[str]):  historic exogenous columns. 
 ...
 - <b>`version`</b> (str):  version of the model. 
 - <b>`modes`</b> (int):  number of modes for the Fourier block. 
 - <b>`mode_select`</b> (str):  method to select the modes for the Fourier block. 
 ...
 - <b>`valid_loss`</b> (PyTorch module):  instantiated validation loss class from [losses collection](https://nixtlaverse.nixtla.io/neuralforecast/losses.pytorch). 
