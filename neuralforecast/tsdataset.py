...
# %% auto 0
__all__ = ['TimeSeriesLoader', 'TimeSeriesDataset', 'IterativeTimeSeriesDataset', 'TimeSeriesDataModule']
...
class _FilesDataset:
    def __init__(
        ...
        self.min_size = min_size
        self.max_size = max_size if max_size is not None else None
...
class IterativeTimeSeriesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        if isinstance(idx, int):
            ...
            temporal = torch.zeros(
                size=(len(temporal_cols), self.files_ds.max_size), dtype=torch.float32
            )
    ...
    def from_data_directory(
        ...
        """We expect files_ds to have one parquet file per timeseries containing a pd df and static df to be a pd df"""
        ...
        dataset = IterativeTimeSeriesDataset(
            files_ds=files_ds,
...
class TimeSeriesDataModule(pl.LightningDataModule):
    ...
    def __init__(
        self,
        dataset: Union[TimeSeriesDataset, IterativeTimeSeriesDataset],
        batch_size=32,
