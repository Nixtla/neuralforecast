...
class NBEATS(BaseModel):
    ...
    **Parameters:**
    ...
    `val_monitor`: str="ptl/val_loss", metric to monitor for early stopping. valid values are "ptl/val_loss", "valid_loss" and "train_loss". Metrics logged with sync_dist require the "ptl/" prefix.
