...
# %% auto 0
__all__ = ['AutoCorrelation', 'AutoCorrelationLayer', 'my_Layernorm', 'moving_avg', 'series_decomp', 'EncoderLayer', 'Encoder',
...
class AutoCorrelationLayer(nn.Module):
    def __init__(self, correlation, hidden_size, n_heads, d_keys=None, d_values=None):
    ...
    *Parameters:*<br>
    ...
    def __init__(
        ...
        **trainer_kwargs,
        ...
        # Decomposition
        self.decomp = series_decomp(moving_avg_window)
