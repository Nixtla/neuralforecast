...
# %% auto 0
__all__ = ['MAE', 'MSE', 'RMSE', 'HuberLoss', 'MAPE', 'SMAPE', 'MASE', 'relMSE', 'QuantileLoss', 'MQLoss', 'wMQLoss',
           'DistributionLoss', 'PMM', 'GMM', 'NBMM', 'Accuracy', 'sCRPS']
...
class HuberLoss(torch.nn.Module):
    ...
    **Parameters:**
    `delta`: float=0.5. The slope of the quantile loss, in the context of quantile regression, the q determines the conditional quantile level.
