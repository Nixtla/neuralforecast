...
# %% auto 0
__all__ = ['BasePointLoss', 'MAE', 'MSE', 'RMSE', 'MAPE', 'SMAPE', 'MASE', 'relMSE', 'QuantileLoss', 'MQLoss',
           'MQLoss_deprecated', 'DistributionLoss', 'PMM', 'GMM', 'NBMM', 'HuberLoss', 'TukeyLoss', 'HuberQLoss',
           'HuberMQLoss', 'Accuracy', 'sCRPS']
...
class MQLoss_deprecated(torch.nn.Module):
    """Multi-Quantile loss
    ...
    **References:**<br>
    ...
    def __init__(self, level=[80, 90], quantiles=None):
        super(MQLoss_deprecated, self).__init__()
