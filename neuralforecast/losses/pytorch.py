...
# %% auto 0
__all__ = ['BasePointLoss', 'MAE', 'MSE', 'RMSE', 'MAPE', 'SMAPE', 'MASE', 'relMSE', 'QuantileLoss', 'MQLoss', 'IQLoss',
           'DistributionLoss', 'PMM', 'GMM', 'NBMM', 'HuberLoss', 'TukeyLoss', 'HuberQLoss', 'HuberMQLoss', 'Accuracy',
           'sCRPS']
    ...
    **References:**<br>
    ...
    def init_sampling_distribution(self, device):
        if self.quantile_sampling == "uniform":
            ...
            self.sampling_distr = Uniform(low=lower_bound, high=upper_bound)
        elif self.quantile_sampling == "beta":
            alpha = torch.tensor([0.5], device=device)
            self.sampling_distr = Beta(concentration0=alpha, concentration1=alpha)
        else:
