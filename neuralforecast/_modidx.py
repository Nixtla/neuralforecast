  ...
  'syms': { 'neuralforecast.auto': { 'neuralforecast.auto.AutoAutoformer': ('models.html#autoautoformer', 'neuralforecast/auto.py'),
            ...
            'neuralforecast.losses.pytorch': { 'neuralforecast.losses.pytorch.Accuracy': ( 'losses.pytorch.html#accuracy',
                                               ...
                                               'neuralforecast.losses.pytorch.MQLoss.domain_map': ( 'losses.pytorch.html#mqloss.domain_map',
                                                                                                    'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.MQLoss_deprecated': ( 'losses.pytorch.html#mqloss_deprecated',
                                                                                                    'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.MQLoss_deprecated.__call__': ( 'losses.pytorch.html#mqloss_deprecated.__call__',
                                                                                                             'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.MQLoss_deprecated.__init__': ( 'losses.pytorch.html#mqloss_deprecated.__init__',
                                                                                                             'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.MQLoss_deprecated.domain_map': ( 'losses.pytorch.html#mqloss_deprecated.domain_map',
                                                                                                               'neuralforecast/losses/pytorch.py'),
