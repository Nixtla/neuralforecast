...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'neuralforecast.auto': { 'neuralforecast.auto.AutoAutoformer': ('models.html#autoautoformer', 'neuralforecast/auto.py'),
                                     ...
                                     'neuralforecast.auto.AutoTimesNet.get_default_config': ( 'models.html#autotimesnet.get_default_config',
                                                                                              'neuralforecast/auto.py'),
                                     'neuralforecast.auto.AutoVCformer': ('models.html#autovcformer', 'neuralforecast/auto.py'),
                                     'neuralforecast.auto.AutoVCformer.__init__': ( 'models.html#autovcformer.__init__',
                                                                                    'neuralforecast/auto.py'),
                                     'neuralforecast.auto.AutoVCformer.get_default_config': ( 'models.html#autovcformer.get_default_config',
                                                                                              'neuralforecast/auto.py'),
