  ...
  'syms': { 'neuralforecast.auto': { 'neuralforecast.auto.AutoAutoformer': ('models.html#autoautoformer', 'neuralforecast/auto.py'),
            ...
            'neuralforecast.losses.pytorch': { 'neuralforecast.losses.pytorch.Accuracy': ( 'losses.pytorch.html#accuracy',
                                               ...
                                               'neuralforecast.losses.pytorch.IQLoss.__init__': ( 'losses.pytorch.html#iqloss.__init__',
                                                                                                  'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.IQLoss.init_sampling_distribution': ( 'losses.pytorch.html#iqloss.init_sampling_distribution',
                                                                                                                    'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.IQLoss.predict_update_quantile': ( 'losses.pytorch.html#iqloss.predict_update_quantile',
                                                                                                                 'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.IQLoss.sample_quantiles': ( 'losses.pytorch.html#iqloss.sample_quantiles',
                                                                                                          'neuralforecast/losses/pytorch.py'),
                                               'neuralforecast.losses.pytorch.IQLoss.training_update_quantile': ( 'losses.pytorch.html#iqloss.training_update_quantile',
                                                                                                                  'neuralforecast/losses/pytorch.py'),
