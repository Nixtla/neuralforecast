  ...
  'syms': { 'neuralforecast.auto': { 'neuralforecast.auto.AutoAutoformer': ('models.html#autoautoformer', 'neuralforecast/auto.py'),
            ...
            'neuralforecast.tsdataset': { 'neuralforecast.tsdataset.BaseTimeSeriesDataset': ( 'tsdataset.html#basetimeseriesdataset',
                                          ...
                                          'neuralforecast.tsdataset._FilesDataset.__init__': ( 'tsdataset.html#_filesdataset.__init__',
                                                                                               'neuralforecast/tsdataset.py')},
            'neuralforecast.utils': { 'neuralforecast.utils.ConformalIntervals': ( 'utils.html#conformalintervals',
                                                                                   'neuralforecast/utils.py'),
                                      'neuralforecast.utils.ConformalIntervals.__init__': ( 'utils.html#conformalintervals.__init__',
                                                                                            'neuralforecast/utils.py'),
                                      'neuralforecast.utils.ConformalIntervals.__repr__': ( 'utils.html#conformalintervals.__repr__',
                                                                                            'neuralforecast/utils.py'),
                                      'neuralforecast.utils.DayOfMonth': ('utils.html#dayofmonth', 'neuralforecast/utils.py'),
                                      ...
                                      'neuralforecast.utils.get_conformal_method': ( 'utils.html#get_conformal_method',
                                                                                     'neuralforecast/utils.py'),
