  ...
  'syms': { 'neuralforecast.auto': { 'neuralforecast.auto.AutoAutoformer': ('models.html#autoautoformer', 'neuralforecast/auto.py'),
            ...
            'neuralforecast.models.moment': { 'neuralforecast.models.moment.ForecastingHead': ( 'models.moment.html#forecastinghead',
                                              ...
                                              'neuralforecast.models.moment.MOMENT.forward': ( 'models.moment.html#moment.forward',
                                                                                               'neuralforecast/models/moment.py'),
                                              'neuralforecast.models.moment.MOMENTPipeline': ( 'models.moment.html#momentpipeline',
                                                                                               'neuralforecast/models/moment.py'),
                                              'neuralforecast.models.moment.MOMENTPipeline.__init__': ( 'models.moment.html#momentpipeline.__init__',
                                                                                                        'neuralforecast/models/moment.py'),
                                              'neuralforecast.models.moment.MOMENTPipeline._validate_model_kwargs': ( 'models.moment.html#momentpipeline._validate_model_kwargs',
                                                                                                                      'neuralforecast/models/moment.py'),
                                              'neuralforecast.models.moment.MOMENTPipeline.init': ( 'models.moment.html#momentpipeline.init',
                                                                                                    'neuralforecast/models/moment.py'),
