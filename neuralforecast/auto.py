...
__all__ = ['AutoRNN', 'AutoLSTM', 'AutoGRU', 'AutoTCN', 'AutoDeepAR', 'AutoDilatedRNN', 'AutoBiTCN', 'AutoMLP', 'AutoNBEATS',
           ...
           'AutoiTransformer', 'AutoVCformer', 'AutoTimesNet', 'AutoStemGNN', 'AutoHINT', 'AutoTSMixer', 'AutoTSMixerx',
...
from .models.vcformer import VCformer
...
class AutoVCformer(BaseAuto):
    ...
    default_config = {
        ...
        "hidden_size": tune.choice([64, 128, 256]),
        "n_heads": tune.choice([4, 8]),
        "hidden_ktd_layers": tune.choice([1, 2, 4]),
        "learning_rate": tune.loguniform(1e-4, 1e-1),
        "scaler_type": tune.choice([None, "robust", "standard"]),
        "max_steps": tune.choice([500, 1000, 2000]),
        "batch_size": tune.choice([32, 64, 128, 256]),
    ...
    def __init__(
        ...
        super(AutoVCformer, self).__init__(
            cls_model=VCformer,
            h=h,
            loss=loss,
            valid_loss=valid_loss,
