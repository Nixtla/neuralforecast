...
def load_models(horizon, input_size, n_series, seed):
    ...
    models = [    
               NHITS(h=horizon,
                    ...
                    valid_loss=valid_loss(level=level),
                    random_seed=seed,
...
def cross_validation(dataset, horizon, metrics, seed=1234567, path_prefix="s3://timenet/isf2025/hubermqloss"):
