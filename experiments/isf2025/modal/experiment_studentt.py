...
from neuralforecast.losses.pytorch import MAE, MQLoss, IQLoss, MSE, HuberLoss, HuberMQLoss, GMM, IQLoss, HuberIQLoss, DistributionLoss
...
def cross_validation(dataset, horizon, metrics, seed=1234567, path_prefix="s3://timenet/isf2025/studentt"):
