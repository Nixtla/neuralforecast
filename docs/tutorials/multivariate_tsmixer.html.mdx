...
<a href="https://colab.research.google.com/github/Nixtla/neuralforecast/blob/main/nbs/docs/tutorials/multivariate_tsmixer.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
![](./multivariate_tsmixer_files/figure-markdown_strict/cell-11-output-1.png)
...
hyperparameter tuning using the [Tune
