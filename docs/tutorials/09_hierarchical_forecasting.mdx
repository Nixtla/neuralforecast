...
![](09_hierarchical_forecasting_files/figure-markdown_strict/cell-5-output-1.png)

```python
plot_series(forecasts_df=Y_df[["unique_id", "ds", "y"]], ids=['TotalAll'])
```

![](09_hierarchical_forecasting_files/figure-markdown_strict/cell-6-output-1.png)
...
![](09_hierarchical_forecasting_files/figure-markdown_strict/cell-12-output-1.png)
