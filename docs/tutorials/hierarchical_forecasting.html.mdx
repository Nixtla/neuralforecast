...
```python
!pip install datasetsforecast hierarchicalforecast neuralforecast
```
...
```python
plot_series(forecasts_df=Y_df.assign(month=80000*Y_df['month']), ids=['TotalAll'])
```

![](/neuralforecast/docs/tutorials/09_hierarchical_forecasting_files/figure-markdown_strict/cell-6-output-1.png)
...
![](/neuralforecast/docs/tutorials/09_hierarchical_forecasting_files/figure-markdown_strict/cell-12-output-1.png)
...
|----|----|----|----|----|----|----|----|
| 0 | Overall | 0.1281±0.0000 | 0.1249±0.0020 | 0.1472±0.0029 | 0.1313±0.0009 | 0.1375±0.0013 | 0.1416 |
| 1 | Country | 0.0472±0.0000 | 0.0431±0.0042 | 0.0842±0.0051 | 0.0471±0.0018 | 0.0622±0.0026 | 0.0263 |
| 2 | State | 0.0710±0.0000 | 0.0637±0.0032 | 0.1012±0.0029 | 0.0723±0.0011 | 0.0820±0.0019 | 0.0904 |
| 3 | Zone | 0.1102±0.0000 | 0.1084±0.0033 | 0.1317±0.0022 | 0.1143±0.0007 | 0.1207±0.0010 | 0.1389 |
| 4 | Region | 0.1544±0.0000 | 0.1554±0.0025 | 0.1705±0.0023 | 0.1591±0.0006 | 0.1646±0.0007 | 0.1878 |
| 5 | Country/Purpose | 0.0819±0.0000 | 0.0700±0.0038 | 0.0995±0.0061 | 0.0723±0.0014 | 0.0788±0.0018 | 0.0770 |
| 6 | State/Purpose | 0.1222±0.0000 | 0.1070±0.0023 | 0.1336±0.0042 | 0.1243±0.0014 | 0.1268±0.0017 | 0.1270 |
| 7 | Zone/Purpose | 0.1869±0.0000 | 0.1887±0.0032 | 0.1955±0.0025 | 0.1919±0.0008 | 0.1949±0.0010 | 0.2022 |
| 8 | Region/Purpose | 0.2509±0.0000 | 0.2629±0.0034 | 0.2615±0.0016 | 0.2694±0.0006 | 0.2698±0.0008 | 0.2834 |
