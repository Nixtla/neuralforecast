...
![](07_time_series_scaling_files/figure-markdown_strict/cell-11-output-1.png)
...
![](07_time_series_scaling_files/figure-markdown_strict/cell-15-output-1.png)
...
However, with temporal normalization models lose the information of the
relative level between different windows. In some cases this global
information within time series is crucial, for instance when an
exogenous variables contains the dosage of a medication. In these cases,
time series scaling (section 3) is preferred.
