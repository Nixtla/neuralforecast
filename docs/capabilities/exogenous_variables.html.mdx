...
loss](../../losses.pytorch.html), the model outputs can be point
forecasts (location estimators) or uncertainty intervals (quantiles).
...
![](./exogenous_variables_files/figure-markdown_strict/cell-5-output-1.png)
...
> **Tip**
>
> You can scale static variables using the `local_static_scaler_type`
> parameter when initializing a `NeuralForecast` instance.
...
![](./exogenous_variables_files/figure-markdown_strict/cell-13-output-1.png)
