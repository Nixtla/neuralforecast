...
`local_scaler_type` | <code>[str](#str)</code> | Scaler to apply per-serie to temporal features before fitting, which is inverted after predicting. Can be 'standard', 'robust', 'robust-iqr', 'minmax' or 'boxcox'. Defaults to None. | <code>None</code>
`local_static_scaler_type` | <code>[str](#str)</code> | Scaler to apply to static exogenous features before fitting. Can be 'standard', 'robust', 'robust-iqr', 'minmax' or 'boxcox'. Defaults to None. | <code>None</code>
...
Name | Type | Description | Default
---- | ---- | ----------- | -------
`df` | <code>pandas, polars or spark DataFrame, or a list of parquet files containing the series</code> | DataFrame with columns \[`unique_id`, `ds`, `y`\] and exogenous variables. If None, a previously stored dataset is required. Defaults to None. | <code>None</code>
`static_df` | <code>pandas, polars or spark DataFrame</code> | DataFrame with columns \[`unique_id`\] and static exogenous. Defaults to None. | <code>None</code>
`val_size` | <code>[int](#int)</code> | Size of validation set. Defaults to 0. | <code>0</code>
`use_init_models` | <code>[bool](#bool)</code> | Use initial model passed when NeuralForecast object was instantiated. Defaults to False. | <code>False</code>
`verbose` | <code>[bool](#bool)</code> | Print processing steps. Defaults to False. | <code>False</code>
...
Name | Type | Description | Default
---- | ---- | ----------- | -------
`df` | <code>pandas, polars or spark DataFrame</code> | DataFrame with columns \[`unique_id`, `ds`, `y`\] and exogenous variables. If a DataFrame is passed, it is used to generate forecasts. Defaults to None. | <code>None</code>
`static_df` | <code>pandas, polars or spark DataFrame</code> | DataFrame with columns \[`unique_id`\] and static exogenous. Defaults to None. | <code>None</code>
`futr_df` | <code>pandas, polars or spark DataFrame</code> | DataFrame with \[`unique_id`, `ds`\] columns and `df`'s future exogenous. Defaults to None. | <code>None</code>
`verbose` | <code>[bool](#bool)</code> | Print processing steps. Defaults to False. | <code>False</code>
...
`level` | <code>list of ints or floats</code> | Confidence levels between 0 and 100. Defaults to None. | <code>None</code>
`quantiles` | <code>list of floats</code> | Alternative to level, target quantiles to predict. Defaults to None. | <code>None</code>
`h` | <code>[int](#int)</code> | Forecasting horizon. If None, uses the horizon of the fitted models. Defaults to None. | <code>None</code>
...
Name | Type | Description | Default
---- | ---- | ----------- | -------
`df` | <code>pandas or polars DataFrame</code> | DataFrame with columns \[`unique_id`, `ds`, `y`\] and exogenous variables. If None, a previously stored dataset is required. Defaults to None. | <code>None</code>
...
`n_windows` | <code>[int](#int)</code> | Number of windows used for cross validation. Defaults to 1. | <code>1</code>
`step_size` | <code>[int](#int)</code> | Step size between each window. Defaults to 1. | <code>1</code>
`val_size` | <code>[int](#int)</code> | Length of validation size. If passed, set `n_windows=None`. Defaults to 0. | <code>0</code>
`test_size` | <code>[int](#int)</code> | Length of test size. If passed, set `n_windows=None`. Defaults to None. | <code>None</code>
`use_init_models` | <code>[bool](#bool)</code> | Use initial model passed when object was instantiated. Defaults to False. | <code>False</code>
`verbose` | <code>[bool](#bool)</code> | Print processing steps. Defaults to False. | <code>False</code>
...
`model_index` | <code>[list](#list)</code> | List to specify which models from list of self.models to save. Defaults to None. | <code>None</code>
`save_dataset` | <code>[bool](#bool)</code> | Whether to save dataset or not. Defaults to True. | <code>True</code>
`overwrite` | <code>[bool](#bool)</code> | Whether to overwrite files or not. Defaults to False. | <code>False</code>
