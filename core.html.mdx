...
`validation_cutoff` | <code>[Optional](#typing.Optional)\[[Any](#typing.Any)\]</code> | Last date of the training set (start of validation). Converted to `val_size` using the data frequency. Cannot be combined with `val_size`. | <code>None</code>
`test_cutoff` | <code>[Optional](#typing.Optional)\[[Any](#typing.Any)\]</code> | Last date of the validation set (start of test). Converted to `test_size` using the data frequency. Cannot be combined with `test_size`. | <code>None</code>
