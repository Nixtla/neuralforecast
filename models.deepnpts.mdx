...
# <kbd>module</kbd> `neuralforecast.models.deepnpts`
...
**Args:**
 ...
 - <b>`hidden_size`</b> (int):  hidden size of dense layers. 
 - <b>`batch_norm`</b> (bool):  if True, applies Batch Normalization after each dense layer in the network. 
 - <b>`dropout`</b> (float):  dropout. 
 - <b>`n_layers`</b> (int):  number of dense layers. 
