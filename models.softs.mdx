...
# <kbd>module</kbd> `neuralforecast.models.softs`
...
## <kbd>class</kbd> `DataEmbedding_inverted`
Data Embedding 
...
```python
__init__(c_in, d_model, dropout=0.1)
```
...
**Args:**
 ...
 - <b>`d_core`</b> (int):  dimension of core in STAD. 
