...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/rmok.py#L17"
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/rmok.py#L161"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/rmok.py#L196"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
> ``` text
>  RevIN (num_features:int, eps=1e-05, affine=True)
> ```
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/rmok.py#L318"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
