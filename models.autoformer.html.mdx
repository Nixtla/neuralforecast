...
![Figure 1. Autoformer Architecture.](/neuralforecast/imgs_models/autoformer.png)
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/autoformer.py#L428"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
