...
# <kbd>module</kbd> `neuralforecast.models.dlinear`
...
**Args:**
 ...
 - <b>`moving_avg_window`</b> (int):  window size for trend-seasonality decomposition. Should be uneven. 
