...
`method` | <code>[str](#str)</code> | One of the supported methods for the computation of prediction intervals:
conformal_error or conformal_distribution. Defaults to "conformal_distribution". | <code>'conformal_distribution'</code>
