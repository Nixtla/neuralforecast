...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/utils.py#L524"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/utils.py#L560"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
