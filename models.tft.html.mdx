...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/tft.py#L629"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-9-output-23.png)
...
| y\_\[lag12\] | 0.52 | 1.00 | -0.72 | 0.07 | 0.02 |
