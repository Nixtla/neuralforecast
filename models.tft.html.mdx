...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/tft.py#L513"
...
>       step_size:int=1, scaler_type:str='robust', drop_last_loader=False,
>       random_seed:int=1, optimizer=None, optimizer_kwargs=None,
...
`grn_activation`: str, activation for the GRN module from \[‘ReLU’,
‘Softplus’, ‘Tanh’, ‘SELU’, ‘LeakyReLU’, ‘Sigmoid’, ‘ELU’, ‘GLU’\].<br/>
`rnn_type`: str=“LSTM”, recurrent neural network (RNN) layer type from
\[“LSTM”,“GRU”\].<br/> `n_rnn_layers`: int=1, number of RNN layers.<br/>
`one_rnn_initial_state`:str=False, Initialize all rnn layers with the
same initial states computed from static covariates.<br/> `loss`: PyTorch
...
last non-full batch.<br/> `alias`: str, optional, Custom name of the
model.<br/> `optimizer`: Subclass of ‘torch.optim.Optimizer’, optional,
user specified optimizer instead of the default choice (Adam).<br/>
`optimizer_kwargs`: dict, optional, list of parameters used by the user
specified `optimizer`.<br/> `lr_scheduler`: Subclass of
...
user specified `lr_scheduler`.<br/> `dataloader_kwargs`: dict, optional,
list of parameters passed into the PyTorch Lightning dataloader by the
`TimeSeriesDataLoader`. <br/> `**trainer_kwargs`: int, keyword trainer
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/tft.py#L778"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/tft.py#L837"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/tft.py#L855"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-10-output-21.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-13-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-14-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-15-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-17-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-18-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-19-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-20-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-21-output-1.png)
...
![](/neuralforecast/models.tft_files/figure-markdown_strict/cell-22-output-1.png)
...
|  | trend | y\_\[lag12\] | month | observed_target | Correlation with Mean Attention |
|----|----|----|----|----|----|
| trend | 1.00 | -0.45 | -0.29 | -0.41 | -0.43 |
| y\_\[lag12\] | -0.45 | 1.00 | -0.56 | -0.18 | 0.68 |
| month | -0.29 | -0.56 | 1.00 | 0.18 | -0.38 |
| observed_target | -0.41 | -0.18 | 0.18 | 1.00 | 0.07 |
| Correlation with Mean Attention | -0.43 | 0.68 | -0.38 | 0.07 | 1.00 |
