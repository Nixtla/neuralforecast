...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/tft.py#L45"
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/stemgnn.py#L29"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/neuralforecast/blob/main/neuralforecast/models/stemgnn.py#L139"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
>           random_seed:int=1, drop_last_loader=False, optimizer=None,
