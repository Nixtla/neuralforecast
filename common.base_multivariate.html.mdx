...
description: >-
  ...
  multivariate neural networks; in contrast to recurrent neural networks these
  models commit to a fixed sequence length input.
...
>                    stat_exog_list=None, drop_last_loader=False,
