---
description: NeuralForecast contains a collection NumPy loss functions aimed to be
  used during the models' evaluation. The most important train signal is the forecast
  ...
  in different evaluation metrics.<br/><br/>
